...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `koenig-jacob`, `koenig-jacob`, `twitter_handle`, `koenig-jacob`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/koenig-jacob/koenig-jacob.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin koenig-jacob/koenig-jacob
...
See the [open issues](https://github.com/koenig-jacob/koenig-jacob/issues) for a full list of proposed features (and known issues).
...
<a href="https://github.com/koenig-jacob/koenig-jacob/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=koenig-jacob/koenig-jacob" alt="contrib.rocks image" />
</a>
